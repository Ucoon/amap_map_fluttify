          ...
          try {
            ...
            switch (methodCall.method) {
              case 'Callback::com.amap.api.trace.TraceListener::onRequestFailed':
                ...
                await var4?.onRequestFailed(args['var1'], args['var2']);
                break;
              case 'Callback::com.amap.api.trace.TraceListener::onTraceProcessing':
                ...
                // handle the native call
                await var4?.onTraceProcessing(args['var1'], args['var2'], (args['var3'] as List)?.map((it) => AmapMapFluttifyAndroidAs<com_amap_api_maps_model_LatLng>(it))?.toList());
                break;
              case 'Callback::com.amap.api.trace.TraceListener::onFinished':
                ...
                // handle the native call
                await var4?.onFinished(args['var1'], (args['var2'] as List)?.map((it) => AmapMapFluttifyAndroidAs<com_amap_api_maps_model_LatLng>(it))?.toList(), args['var3'], args['var4']);
                break;
              default:
          ...
          try {
            ...
            switch (methodCall.method) {
              case 'Callback::com.amap.api.trace.TraceStatusListener::onTraceStatus':
                ...
                // handle the native call
                await var1?.onTraceStatus((args['var1'] as List)?.map((it) => AmapMapFluttifyAndroidAs<com_amap_api_trace_TraceLocation>(it))?.toList(), (args['var2'] as List)?.map((it) => AmapMapFluttifyAndroidAs<com_amap_api_maps_model_LatLng>(it))?.toList(), args['var3']);
                break;
              default:
                throw MissingPluginException('方法${methodCall.method}未实现');
                break;
