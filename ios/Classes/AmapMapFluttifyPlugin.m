...
@interface AmapMapFluttifyPlugin (_Delegate) <MAMapViewDelegate, MAMultiPointOverlayRendererDelegate, MATraceDelegate> @end
...
- (void)mapViewRequireLocationAuth : (CLLocationManager*)locationManager
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    [channel invokeMethod:@"Callback::MAMapViewDelegate::mapViewRequireLocationAuth" arguments:@{@"locationManager": arglocationManager == nil ? [NSNull null] : arglocationManager}];
  });
