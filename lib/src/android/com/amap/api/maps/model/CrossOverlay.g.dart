...
class com_amap_api_maps_model_CrossOverlay extends java_lang_Object  {
          ...
          try {
            ...
            switch (methodCall.method) {
              case 'Callback::com.amap.api.maps.model.CrossOverlay.GenerateCrossImageListener::onGenerateComplete':
                ...
                await var1?.onGenerateComplete(AmapMapFluttifyAndroidAs(args['var1']), args['var2']);
                break;
              default:
  ...
  Future<void> setOnCrossVectorUpdateListener(com_amap_api_maps_model_CrossOverlay_OnCrossVectorUpdateListener var1) async {
    ...
    // handle native call
    MethodChannel('com.amap.api.maps.model.CrossOverlay::setOnCrossVectorUpdateListener::Callback@$refId', kAmapMapFluttifyMethodCodec)
        .setMethodCallHandler((methodCall) async {
          try {
            final args = methodCall.arguments as Map;
            switch (methodCall.method) {
              case 'Callback::com.amap.api.maps.model.CrossOverlay.OnCrossVectorUpdateListener::onUpdate':
                // print log
                if (fluttifyLogEnabled) {
                  debugPrint('fluttify-dart-callback: onUpdate([\'var1\':${args['var1']}, \'var2\':${args['var2']}])');
                }
          
                // handle the native call
                await var1?.onUpdate(args['var1'], AmapMapFluttifyAndroidAs(args['var2']));
                break;
              default:
                throw MissingPluginException('方法${methodCall.method}未实现');
                break;
