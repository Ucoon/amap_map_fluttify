...
class com_amap_api_maps_model_BitmapDescriptor extends java_lang_Object with android_os_Parcelable {
  ...
  //region getters
  static Future<String> get_static_INVALID_ID() async {
    final __result__ = await kAmapMapFluttifyChannel.invokeMethod("com.amap.api.maps.model.BitmapDescriptor::get_INVALID_ID", );
    return __result__;
  }
...
extension com_amap_api_maps_model_BitmapDescriptor_Batch on List<com_amap_api_maps_model_BitmapDescriptor> {
  //region getters
  Future<List<String>> get_static_INVALID_ID_batch() async {
    final resultBatch = await kAmapMapFluttifyChannel.invokeMethod("com.amap.api.maps.model.BitmapDescriptor::get_INVALID_ID_batch", [for (final __item__ in this) {'__this__': __item__}]);
